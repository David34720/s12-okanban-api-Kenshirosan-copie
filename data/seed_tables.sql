...
-- Après notre seed MANUEL, on met à jour la séquence du GENERATED BY DEFAULT AS IDENTITY pour que le prochain ID soit supérieur au MAX des id actuels
SELECT
    setval(
        'card_id_seq',
        (
